  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      ...
      builder: (context, state) {
        return StateView(
          isLoading: state.isInitialFilmsLoading,
          hasError: state.hasFilmsError && state.filmCategories.isEmpty,
          errorMessage: 'Gagal memuat film',
          onRetry: () =>
              context.read<HomeBloc>().add(const HomeLoadRequested()),
          loadingView: const WFilmPilihanSectionShimmer(),
          child: WFilmPilihanSection(
